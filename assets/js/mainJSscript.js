$(document).ready(function(){	
    ...
    $(".item_form").submit(function(e){
        ...
        $.ajax({
            url: "/santon-elo/private/view/shoppingCartData.php",
            type: "POST",
            dataType:"json", 
            data: form_data
            ...
            $("#cart_update_info").append("<div id='new_item_added'><i class='glyphicon glyphicon-ok' style='color:green;'></i> Santon ajouté au panier</div>").fadeIn('fast').delay(2000).fadeOut('fast');
	...
	$(".shopping_cart_info").click(function(e) {
		...
		$("#shopping_cart_output" ).load( "/santon-elo/private/view/shoppingCartData.php", {"load_cart_items":"true"});
	});	
	...
	$("#shopping_cart_output").on('click', 'a.remove_item_from_cart', function(e) {
		...
		$.getJSON( "/santon-elo/private/view/shoppingCartData.php", {"remove_item_from_cart":item_id} , function(data){ //get Item id
    ...
    $("#shopping_cart_output").on("click", "a.add_itm_qty", function(e){
        ...
        $.getJSON( "/santon-elo/private/view/shoppingCartData.php", {"add_itm_qty":item_id} , function(data){ 
    ...
    /* Change item quantity - SUBTRUCT */
     $("#shopping_cart_output").on("click", "a.subtruct_itm_qty", function(e){
        e.preventDefault(); 
        var item_id = $(this).attr("item_id");   
        $.getJSON( "/santon-elo/private/view/shoppingCartData.php", {"subtruct_itm_qty":item_id} , function(data){ 
            // update specific item quantity on event
			$(".shopping_cart_info").click(); 
		});
    }); 
