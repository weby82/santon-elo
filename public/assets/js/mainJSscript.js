...
$(document).ready(function(){	
    ...
    $(".item_form").submit(function(e){
        ...
        $.ajax({
            url: cheminPanier, //"url vers shoppingCartData.php" variable cheminPanier defini dans le header
            type: "POST",
            dataType:"json", 
            data: form_data
	...
	$(".shopping_cart_info").click(function(e) {
		...
		$("#shopping_cart_output" ).load( cheminPanier, {"load_cart_items":"true"});
	});	
