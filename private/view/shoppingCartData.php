        ...
        ?>			
            <tr class='itemInCardRow'>            
                <td class='itemInCartDisplay'>
                    <img class='img-responsive item_disp_image' style='max-width:80px; float:left;' src="<?php echo $item["item_image"]; ?>">
                </td>
        ...
        ?>
            ...
            <tr>                 
                <td class='itemInCartDisplay' colspan='4'>
                    <div>
                        <a href='checkOut.php' title="Review Cart and Check-Out"><button type="button" class="btn btn-default checkoutButton">COMMANDER</button></a>
