	<footer>
	 ...
	 <!-- JS pour le formulaire de contact. désolée il est en JS et pas en Jquery Liinaa -->
	 <script type="text/javascript" src="<?php echo $this->assetUrl('js/liinaa-contact.js') ?>"></script>
